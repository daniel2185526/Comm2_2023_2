...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tabla_de_verdad_constelacion = tabla_de_verdad_constelacion = (0.77j,-0.77j)
        ...
        self.h = h = [1]*Sps
        self.Rb = Rb = Rs*bps
        self.Frecuency = Frecuency = 1000000
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, Frecuency, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, Frecuency, 1, 0, 0)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 2, 1000))), True)
        self.analog_noise_source_x_0_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 0.05, 0)
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_add_xx_0_0, 0))
    ...
    def set_Frecuency(self, Frecuency):
        ...
        self.analog_sig_source_x_0_0.set_frequency(self.Frecuency)
